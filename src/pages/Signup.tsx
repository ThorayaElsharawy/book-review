            ...
            <div className="w-full flex-1 mt-8">
              <div className="mx-auto max-w-xs">
                ...
                <form onSubmit={(e) => handleSubmitForm(e)}>
                  ...
                  />
                  <input
                    value={passwordConfirem}
                    onChange={(e) => setPasswordConfirem(e.target.value)}
                  ...
                  rounded-lg hover:bg-indigo-700 transition-all duration-300 ease-in-out focus:shadow-outline focus:outline-none"
                  >
                    Sign Up
                  </button>
                </form>
